...
static const char* c_sMagic = "Sony PS2 Memory Card Format ";
static const char* c_sVersion = "1.2.0.0";
static void SIO::PS2_FormatMemCard ( PS2_MC* mc )
{
	int i;
...
static u64 SIO::SIO2in_DMA_Ready ()
{
	return _SIO->SIO2_InputReady;
}

// dma#12 ready function
static u64 SIO::SIO2out_DMA_Ready ()
{
...
static u32 SIO::DMA_ReadBlock ( u32* pMemoryPtr, u32 Address, u32 WordCount )
{
...
static u32 SIO::DMA_WriteBlock ( u32* pMemoryPtr, u32 Address, u32 WordCount )
{
	u8 *Data;
	u32 ByteCount;
