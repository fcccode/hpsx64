...
namespace Playstation1
{
	...
	public:
		...
		static const double c_dCDReadx1_Cycles = 491520.0L;
		static const double c_dDVDReadx1_Cycles = 54518.1357838179L;
		...
		static const long c_lDVDNoSeekDelta = 8;
		...
		static void Set_EventCallback ( funcVoid1 UpdateEvent_CB ) { _CDVD->NextEvent_Idx = UpdateEvent_CB ( sRun ); };
