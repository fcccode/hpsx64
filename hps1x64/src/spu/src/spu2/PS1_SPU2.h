...
namespace Playstation1
{
	...
	public:
		...
		static const int c_iNumberOfRegisters = 0x400;
		...
		*/
		...
		//struct SpuRegs1_Layout
		//{
		//	CoreRegs1_t CoreRegs1 [ 2 ];
		//};
	...
	public:
		...
		static void Set_EventCallback ( funcVoid1 UpdateEvent_CB ) { _SPU2->NextEvent_Idx = UpdateEvent_CB ( sRun ); };
