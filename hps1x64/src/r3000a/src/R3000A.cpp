...
//#endif
	...
	rs = new Recompiler ( this, 19 - DataBus::c_iInvalidate_Shift, DataBus::c_iInvalidate_Shift + 7, DataBus::c_iInvalidate_Shift );
...
static void Cpu::DebugWindow_Enable ()
{
	...
	if ( !DebugWindow_Enabled )
	{
		...
		GPR_ValueList->AddVariable ( "IsBusy", & _CPU->Status.isSomethingBusy );
