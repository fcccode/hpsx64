...
void DataBus::Start ()
{
	...
	*/
	...
	/*
	//ConnectDevice_Read ( 0xffff8000, ScratchPad_Read );
	//ConnectDevice_Write ( 0xffff8000, ScratchPad_Write );
	ConnectDevice_Read ( 0xffff8000, DirectCacheMem_Read );
	ConnectDevice_Write ( 0xffff8000, DirectCacheMem_Write );
	*/
