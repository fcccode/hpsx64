...
char* x64Encoder::Get_CodeBlock_StartPtr ()
{
	...
	return (void*) & x64CodeArea [ lCodeBlockSize * x64CurrentCodeBlockIndex ];
}

char* x64Encoder::Get_CodeBlock_EndPtr ()
{
	// get offset for end of code block
	return (void*) & x64CodeArea [ ( lCodeBlockSize * ( x64CurrentCodeBlockIndex + 1 ) ) - 1 ];
}
...
char* x64Encoder::Get_XCodeBlock_StartPtr ( long lCodeBlockIndex )
{
	...
	if ( lCodeBlockIndex < lNumberOfCodeBlocks )
	{
		...
		return (void*) & x64CodeArea [ lCodeBlockSize * lCodeBlockIndex ];
	}
...
{
	return x64EncodeRipOffset16 ( X64OP_ADC, DestReg, (char*) SrcPtr );
}

bool x64Encoder::AdcRegMem32 ( long DestReg, long* SrcPtr )
{
	return x64EncodeRipOffset32 ( X64OP_ADC, DestReg, (char*) SrcPtr );
}

bool x64Encoder::AdcRegMem64 ( long DestReg, long long* SrcPtr )
{
	return x64EncodeRipOffset64 ( X64OP_ADC, DestReg, (char*) SrcPtr );
}
...
{
	return x64EncodeRipOffset16 ( MAKE2OPCODE( X64OP1_CMOVE, X64OP2_CMOVE ), DestReg, (char*) SrcPtr );
}

bool x64Encoder::CmovNERegMem16 ( long DestReg, short* SrcPtr )
{
	return x64EncodeRipOffset16 ( MAKE2OPCODE( X64OP1_CMOVNE, X64OP2_CMOVNE ), DestReg, (char*) SrcPtr );
}
...
{
	return x64EncodeRipOffset32 ( MAKE2OPCODE( X64OP1_CMOVNE, X64OP2_CMOVNE ), DestReg, (char*) SrcPtr );
}
...
{
	return x64EncodeRipOffset64 ( MAKE2OPCODE( X64OP1_CMOVNE, X64OP2_CMOVNE ), DestReg, (char*) SrcPtr );
}
...
{
	return x64EncodeRipOffset16 ( MAKE2OPCODE( X64OP1_CMOVS, X64OP2_CMOVS ), DestReg, (char*) SrcPtr );
}

bool x64Encoder::CmovSRegMem32 ( long DestReg, long* SrcPtr )
{
	return x64EncodeRipOffset32 ( MAKE2OPCODE( X64OP1_CMOVS, X64OP2_CMOVS ), DestReg, (char*) SrcPtr );
}

bool x64Encoder::CmovSRegMem64 ( long DestReg, long long* SrcPtr )
{
	return x64EncodeRipOffset64 ( MAKE2OPCODE( X64OP1_CMOVS, X64OP2_CMOVS ), DestReg, (char*) SrcPtr );
}
...
{
	return x64EncodeRipOffset16 ( MAKE2OPCODE( X64OP1_CMOVNS, X64OP2_CMOVNS ), DestReg, (char*) SrcPtr );
}

bool x64Encoder::CmovNSRegMem32 ( long DestReg, long* SrcPtr )
{
	return x64EncodeRipOffset32 ( MAKE2OPCODE( X64OP1_CMOVNS, X64OP2_CMOVNS ), DestReg, (char*) SrcPtr );
}

bool x64Encoder::CmovNSRegMem64 ( long DestReg, long long* SrcPtr )
{
	return x64EncodeRipOffset64 ( MAKE2OPCODE( X64OP1_CMOVNS, X64OP2_CMOVNS ), DestReg, (char*) SrcPtr );
}
...
{
	return x64EncodeRipOffset64 ( X64OP_MOVSXD, DestReg, (char*) SrcPtr );
}
...
{
	x64EncodeRegReg32 ( MAKE4OPCODE( 0x66, 0x0f, 0x3a, 0x0e ), sseDestReg, sseSrcReg );
	return x64EncodeImmediate8 ( Imm8 );
}
...
{
	//return x64EncodeRegMemV ( VEX_128BIT, 0, VEX_PREFIXNONE, VEX_PREFIX0F, AVXOP_MOVAPS_TOMEM, sseSrcReg, 0, x64BaseReg, x64IndexReg, Scale, Offset );
	return x64EncodeRegMem32 ( MAKE3OPCODE ( 0x66, 0x0f, 0x7f ), sseSrcReg, x64BaseReg, x64IndexReg, Scale, Offset );
}
...
bool x64Encoder::movdqa_from_mem128 ( long sseDestReg, long x64BaseReg, long x64IndexReg, long Scale, long Offset )
{
	...
	return x64EncodeRegMem32 ( MAKE3OPCODE ( 0x66, 0x0f, 0x6f ), sseDestReg, x64BaseReg, x64IndexReg, Scale, Offset );
}
...
bool x64Encoder::Call ( void* Target )
{
	long Offset;
