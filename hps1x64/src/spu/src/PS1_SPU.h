...
namespace Playstation1
{
	...
	public:
		...
		*/
		...
		static ssX Calc_sample_gx ( u32 SampleOffset_Fixed16, ssX Sample0, ssX Sample1, ssX Sample2, ssX Sample3 );
		
		static ssX Calc_sample_filter ( ssX x0, ssX x1, ssX x2, ssX y1, ssX y2 );
		
		// sample history for filter
		//u64 Reverb_FSampleCounter, FSampleCounter;
		ssX LReverb_x1, LReverb_x2, LReverb_y1, LReverb_y2;
		ssX RReverb_x1, RReverb_x2, RReverb_y1, RReverb_y2;
		ssX Lx1, Lx2, Ly1, Ly2;
		ssX Rx1, Rx2, Ry1, Ry2;
		...
		ssX ReadReverbBuffer ( u32 Address );
		void WriteReverbBuffer ( u32 Address, ssX Value );
		...
		// processes reverb
		ssX ReverbL_Output, ReverbR_Output;
		u32 Reverb_BufferAddress;
		void ProcessReverbL ( ssX LeftInput );
		void ProcessReverbR ( ssX RightInput );
		...
		void UpdatePitch ( int Channel, u32 Pitch, u32 Reg_PMON, ssX PreviousSample );
		...
		ssX DecodedBlocks [ c_iNumberOfChannels * 32 ];
		
		// buffer for filter
		ssX FilterBuf [ c_iNumberOfChannels * 4 ];
		ssX OutputFirBufL [ c_iNumberOfChannels * 2 ];
		ssX InputFirBufL [ c_iNumberOfChannels * 4 ];
		ssX OutputFirBufR [ c_iNumberOfChannels * 2 ];
		ssX InputFirBufR [ c_iNumberOfChannels * 4 ];
		ssX Core_OutputFirBuf [ 2 * 2 ];
		ssX Core_InputFirBuf [ 2 * 4 ];
		...
		static void Set_EventCallback ( funcVoid1 UpdateEvent_CB ) { _SPU->NextEvent_Idx = UpdateEvent_CB ( sRun ); };
